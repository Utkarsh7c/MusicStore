    ...
    return (
        <aside style={useStyle.component} className={"aside-bar"}>
            ...
            <div className="aside-bar-container playlist">
                ...
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/instrumental"}  title={"Playlist-1"}/>
                <SideBarOptions className={"lib-sub"} Icon={PlaylistPlay} href={"/home/playlist/electronic"}  title={"Playlist-2"}/>
            </div>
        </aside>
    );
}
